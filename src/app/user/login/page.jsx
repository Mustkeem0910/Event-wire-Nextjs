...
const Page = () => {
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      ...
      // Store tokens in a secure way (e.g., in local storage or HTTPOnly cookies)
      // Redirect or perform other actions as needed
      console.log('Login successful:', data);
      alert("COUSTOMER SECTION COMING SOON")
    } catch (error) {
        ...
        <div className="container mx-auto flex border border-1 border-gray-300 max-w-4xl">
          ...
          <div className="flex justify-center text-md my-6">
            ...
            <div className="mt-5 w-full container px-10 ">
             ...
             <button className="text-black  text-sm ml-2 hover:text-primary focus:outline-none" onClick={handleClick2}>
    Forget Password
  </button>
             </div>
              ...
              <button
                ...
                className="bg-white text-black  mb-10 font-semibold border border-black p-2 rounded-md  hover:bg-primary  hover:border-primary hover:text-white w-full"
              >
                Login
              </button>
